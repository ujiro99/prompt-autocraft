...
This is a browser extension called "prompt-metacraft" that enables saving and recalling prompt history passed to generative AI services. It's built to help users manage their AI conversation history across different AI platforms, starting with ChatGPT support.
